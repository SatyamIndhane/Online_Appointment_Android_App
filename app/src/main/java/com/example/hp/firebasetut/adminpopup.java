...
public class adminpopup extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adminpopup);
    ...
    private void edituserinfo() {
        ...
        String Reason1 = tvDate.getText().toString();
        String Date = tvReason1.getText().toString();
